        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2 sm:gap-4">
            <div className="card p-3 sm:p-4">
              ...
              <p className="text-lg sm:text-2xl font-bold text-celtic-dark">
                £{boardStats.totalRevenue.toLocaleString()}
              </p>
            ...
            >
              <div className="flex items-start gap-4">
                <div className="w-14 h-14 bg-celtic-blue/10 rounded-lg flex items-center justify-center group-hover:bg-celtic-blue/20 transition-colors">
                  <svg
                    className="w-7 h-7 text-celtic-blue"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                    aria-hidden="true"
            ...
            >
              <div className="flex items-start gap-4">
                <div className="w-14 h-14 bg-celtic-yellow/20 rounded-lg flex items-center justify-center group-hover:bg-celtic-yellow/30 transition-colors">
                  <svg
                    className="w-7 h-7 text-celtic-yellow"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                    aria-hidden="true"
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-500 mt-1">Manage monthly draw and members</p>
                  <div className="mt-3 flex items-center gap-2 text-xs">
                    <span className="px-2 py-0.5 bg-green-100 text-green-700 rounded-full">Active</span>
                  </div>
                </div>
            ...
            <Link href="/admin/news" className="card p-6 hover:shadow-lg transition-shadow group">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-500 mt-1">Post news articles and updates</p>
                  <div className="mt-3 flex items-center gap-2 text-xs">
                    <span className="px-2 py-0.5 bg-green-100 text-green-700 rounded-full">Active</span>
                  </div>
                </div>
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-500 mt-1">Manage volunteer sign-ups</p>
                  <div className="mt-3 flex items-center gap-2 text-xs">
                    <span className="px-2 py-0.5 bg-green-100 text-green-700 rounded-full">Active</span>
                  </div>
                </div>
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-500 mt-1">Review sponsorship requests</p>
                  <div className="mt-3 flex items-center gap-2 text-xs">
                    <span className="px-2 py-0.5 bg-green-100 text-green-700 rounded-full">Active</span>
                  </div>
                </div>
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-500 mt-1">Send weekly updates to subscribers</p>
                  <div className="mt-3 flex items-center gap-2 text-xs">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3">
            ...
            <Link href="/news" className="card p-4 text-center hover:shadow-md transition-shadow">
              <svg
                className="w-6 h-6 mx-auto mb-2 text-orange-600"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
                aria-hidden="true"
            ...
            <Link
              href="/sponsors/boards"
              className="card p-4 text-center hover:shadow-md transition-shadow"
            >
              <svg
                className="w-6 h-6 mx-auto mb-2 text-celtic-yellow"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
                aria-hidden="true"
            ...
            >
              <svg
                className="w-6 h-6 mx-auto mb-2 text-celtic-blue"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
                aria-hidden="true"
