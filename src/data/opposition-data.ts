...
export const oppositionTeams: OppositionTeam[] = [
  ...
  { id: 'abercarn-united', name: 'Abercarn United', ground: 'Recreation Ground', colours: 'Blue and White', badge: '/images/opponents/abercarn-united.png' },
  { id: 'abergavenny-town', name: 'Abergavenny Town', ground: 'Pen-y-Pound', colours: 'Blue and White', badge: '/images/opponents/abergavenny-town.png' },
  { id: 'blaenavon-blues', name: 'Blaenavon Blues', ground: 'Recreation Ground', colours: 'Blue', badge: '/images/opponents/blaenavon-blues.png' },
  { id: 'brecon-corries', name: 'Brecon Corries', ground: 'The Rich Field', colours: 'Green and White', badge: '/images/opponents/brecon-corries.png' },
  ...
  { id: 'newport-corinthians', name: 'Newport Corinthians', ground: 'Coronation Park', colours: 'Green and White', badge: '/images/opponents/newport-corinthians.png' },
  { id: 'risca-united', name: 'Risca United', ground: 'Ty-Isaf', colours: 'Red and Black', badge: '/images/opponents/risca-united.png' },
  { id: 'tredegar-town', name: 'Tredegar Town', ground: 'Tredegar Recreation Ground', colours: 'Blue and White', badge: '/images/opponents/tredegar-town.png' },
  { id: 'undy', name: 'Undy', ground: 'The Causeway', colours: 'Yellow and Blue', badge: '/images/opponents/undy.png' },
];
