...
const navItems: NavItem[] = [
  ...
  { label: 'Fixtures', href: '/fixtures' },
  {
    ...
    children: [
      ...
      { label: 'Squad Profiles', href: '/players' },
      { label: 'Reserve Teams', href: '/teams/mens-seconds' },
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Officials', href: '/club/officials' },
  ...
  },
  {
    ...
    href: '/celtic-bond',
    children: [
      { label: 'Celtic Bond Lottery', href: '/celtic-bond' },
