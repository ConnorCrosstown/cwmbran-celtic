    ...
    <section className="py-16 md:py-20 bg-gray-100">
      <div className="container mx-auto px-4">
        ...
        <div className="mt-10 bg-gradient-to-r from-celtic-blue to-celtic-blue-dark rounded-xl p-6 md:p-8 text-center">
          ...
          <p className="text-celtic-yellow mb-6 max-w-xl mx-auto">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 bg-celtic-yellow hover:bg-celtic-yellow-light text-celtic-dark px-6 py-3 rounded-lg font-semibold transition-colors"
          >
